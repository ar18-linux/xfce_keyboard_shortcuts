...
echo "${ar18_sudo_password}" | sudo -Sk chown "${user_name}:${user_name}" "${install_dir}/xfce4-keyboard-shortcuts.xml"
echo "${ar18_sudo_password}" | sudo -Sk chmod 664 "${install_dir}/xfce4-keyboard-shortcuts.xml"
